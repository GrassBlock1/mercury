...
import Note from '/src/components/helper/authors/Note.astro';
...
```
Or use with extended Markdown syntax:
...
```
#### Author's Notes
A special type of Callout can be used as author's Notes. This can be useful if a post is collaborated with multiple authors.

<Note authorId='Glados'>
    This is a additional note from another author.
</Note>
...
<Callout type="warning">
    To make this work correctly, you should always use the **'id' of the author** :
    ```yaml
    Glados: # you should use this
        name: "Glados"
